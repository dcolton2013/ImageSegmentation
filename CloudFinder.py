...
mask9112 = misc.imread('./Cameras/10870/mask/9112.png')
mask9112 = misc.imresize(mask9112,(70,80),interp = 'nearest')
path_cloudy_10870 = os.path.join(os.getcwd(), 'Cameras/9112/cloudy/')
path_clear_10870 = os.path.join(os.getcwd(), 'Cameras/9112/clear/')
...
mask19106 = misc.imread('./Cameras/10870/mask/19106.png')
